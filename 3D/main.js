...
const camera = new GameObject("camera", Transform.identity, [new Camera(1)]);
scene.addGameObject(camera);
const point = new GameObject("point", Transform.identity, [new MeshRenderer(PrefabShape.edge(new Vector3(0, 0, 0), new Vector3(0, 0.2, 0)))]);
const cube = new GameObject("cube", Transform.identity, [new MeshRenderer(PrefabShape.cube(Vector3.one.div(3)))]);
...
setInterval(function () {
    //cube.transform.translate(new Vector3(0.005, 0, 0));
